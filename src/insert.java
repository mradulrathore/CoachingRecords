 ...
 * insert.java
 *
 * Created on 19 Oct, 2017, 9:42:33 PM
 */
...
DriverManager.getConnection("jdbc:mysql://localhost:3306/coachingc","root","a") ;
    ...
    private void instbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_instbtnActionPerformed
        // coding for adding new record
         try{
            String q="insert into coaching values('"+adn.getText()+"','"+stnm.getText()+
                    "','"+fnm.getText()+"','"+cl.getText()+"','"+mn.getText()+"','"+fs.getText()+"','"+sub.getText()+"');";
            st.executeUpdate(q);
